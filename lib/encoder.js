...
export class LPPEncoder {
    ...
    */
    addAnalogInput(channel, value) {
        ...
        var floorVal = floor(value, 2) * 100
    ...
    */
    addDigitalInput(channel, value) {
        ...
        this.buffer.writeUInt8(channel, this.cursor++)
        this.buffer[this.cursor++] = DIGITAL_INPUT
    ...
    */
    addTemperature(channel, value) {
        ...
        var floorVal = floor(value, 1) * 10

        this.buffer.writeUInt8(channel, this.cursor++)
        this.buffer[this.cursor++] = TEMPERATURE
        this.buffer.writeInt16BE(floorVal, this.cursor)
        this.cursor +=2
    ...
    */
    addLuminosity(channel, value) {
        ...
        this.buffer.writeUInt8(channel, this.cursor++)
        this.buffer[this.cursor++] = LUMINOSITY
    ...
    */
    addRelativeHumidity(channel, value) {
        ...
        this.buffer.writeUInt8(channel, this.cursor++)
        this.buffer[this.cursor++] = HUMIDITY
